 ...
 *las guarde en un ArrayList de tipo Double. A continuación el programa calculará
 *la altura media de todos los alumnos, cuantos alumnos hay más altos que la media
 *y cuantos más bajos.
...
en el ArrayList. Este método recibe como parámetros el ArrayList inicialmente vacío y el número de alumnos a leer.
...
muestra el número de alumnos con altura superior e inferior a la media.
Recibe como parámetros el ArrayList con las alturas de todos los alumnos y la media
...
/*
 * Ahora creamos un metodo LeerAltura con el tamaño N alumnos del metodo de NumerodeAlumnos y
 * y las introducimos en la lista de alturas por alumnos
 */
